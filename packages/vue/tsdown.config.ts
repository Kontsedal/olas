...
// production build, with every `if (__DEV__)` branch (the missing-scope
// warning) stripped. `dist/dev/` is the `development` condition, which Vite,
// webpack, Next and Rspack resolve in dev. tsdown cleans once, before both.
